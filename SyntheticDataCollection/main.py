...
from SyntheticDataCollection.utils.tcpip import TCPServer
from utils import real2IQ, dtype_det_2d_int, dtype_det_2d_float, make_video
...
class RadarSignalProcessor:
    ...
    def process_frame(self, frame):
        ...
        psi, theta, ranges, xyz = dsp.beamforming_naive_mixed_xyz(angle_input, det_2d['range_idx'], self.range_res, 
